/**
 * @namespace: addons/tempvoice/select_menus/tv-trust-menu.js
 * @type: Module
...
class TvTrustMenuSelectMenu extends BaseSelectMenu {
	selectMenu = {
		...
		try {
			...
			await interaction.update({
				components: await simpleContainer(
					...
					await t(
						interaction,
						'tempvoice.select_menus.tv-trust-menu.trust.success',
						{
...
module.exports = TvTrustMenuSelectMenu;
