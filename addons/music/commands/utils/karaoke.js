/**
 * @namespace: addons/music/commands/utils/karaoke.js
 * @type: Command
...
class KaraokeCommand extends BaseCommand {
	subcommand = true;
	...
	async execute(interaction) {
		...
		return musicHandlers.handleKaraoke(interaction, player);
	}
}

exports.default = KaraokeCommand;
