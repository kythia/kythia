		...
		try {
			...
			if (!existing) {
				const components = await createContainer(interaction, {
					description: await t(
						interaction,
						'core.commands.utils.kyth.team.delete.not.found',
						{
							tag: user.tag,
						},
					),
			...
			const components = await createContainer(interaction, {
				title: await t(
					interaction,
					'core.commands.utils.kyth.team.delete.title',
				),
				description: await t(
					interaction,
					'core.commands.utils.kyth.team.delete.success',
					{
						tag: user.tag,
						id: user.id,
					},
			...
			const components = await createContainer(interaction, {
				description: await t(
					interaction,
					'core.commands.utils.kyth.team.delete.error',
					{
						error: error.message,
					},
				),
